...
@section('body')
    ...
    {{-- add student form --}}
    <form class="w-full bg-white shadow-md p-5 rounded-lg flex flex-col gap-3 mt-5" action="{{ route('student.edit') }}" method="POST">
        @csrf
        ...
        <input type="hidden" name="toEditStudentName" value="{{ $toEditStudent['name'] }}">
